...
def get_recommendations():
    """runs two models in sequence, retrieval then ranking models

    Returns:
        json: sorted list of ranked movies
    """
    ...
    movies_scores = list(np.squeeze(ranking_response.json()["predications"]))
    ranked_movies = [
